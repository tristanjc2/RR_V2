  ...
  <footer className="bg-green-700 text-white py-6 mt-12">
    <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between">
      <div className="text-center md:text-left w-full md:w-auto">
        <p>&copy; {new Date().getFullYear()} Reaper Resins. All rights reserved.</p>
        <p className="text-sm mt-2 md:mt-0">This is a fictional demo. Cannabis products are for adults only. Please consume responsibly.</p>
      </div>
      <div className="flex justify-center md:justify-end gap-6 mt-4 md:mt-0 w-full md:w-auto">
        {/* Telegram */}
        <a href="https://t.me/+TzgGpmtVBHY0MGY5" target="_blank" rel="noopener noreferrer" aria-label="Telegram" className="hover:scale-110 transition">
        ...
        {/* Instagram */}
        <a href="https://www.instagram.com/officialreaperb/profilecard/?igsh=MXh6OW9jYzUyeG1lMg%3D%3D" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="hover:scale-110 transition">
          <svg width="28" height="28" fill="none" viewBox="0 0 24 24" className="text-green-700" xmlns="http://www.w3.org/2000/svg">
            <circle cx="12" cy="12" r="12" fill="#fff"/>
        ...
        {/* SMS */}
        <a href="sms:+12077379594" aria-label="Text Message" className="hover:scale-110 transition">
          <svg width="28" height="28" fill="none" viewBox="0 0 24 24" className="text-green-700" xmlns="http://www.w3.org/2000/svg">
            <circle cx="12" cy="12" r="12" fill="#fff"/>
        ...
        {/* Phone */}
        <a href="tel:+12077379594" aria-label="Phone" className="hover:scale-110 transition">
          <svg width="28" height="28" fill="none" viewBox="0 0 24 24" className="text-green-700" xmlns="http://www.w3.org/2000/svg">
            <circle cx="12" cy="12" r="12" fill="#fff"/>
